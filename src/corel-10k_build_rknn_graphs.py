...
if __name__=='__main__':
    ...
    fn_result = 'data/corel-10k_rank_voc.txt'
    #fn_result = 'data/corel-10k_rank_hsv.txt'
    fn_result_reranking = 'data/corel-10k_rerank_voc.txt'
    #fn_result_reranking = 'data/corel-10k_rerank_hsv.txt'
    fn_label = 'data/corel-10k_list_images_labels.txt'
    fn_folder_graph = 'data/corel-10k_graphs/'
